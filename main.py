...
def capture_screen_region(x, y, desired_width, desired_height):
...
def capture_screen_region_mss(x, y, width, height):
    with mss() as sct:
...
while True:
    ...
    imgGame = capture_screen_region_mss(450, 300, 650, 200)
